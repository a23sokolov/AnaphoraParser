...
PATH_ARTICLES = '/Users/alexey/Desktop/Diploma/DepartmentOfInfTech/Source/SyntaxParser/SyntagRusParser/source/sentence_to_malt/articles'
...
syntax_list = ['пасс-анал', 'об-аппоз', 'дистанц', 'нум-аппоз', '1-компл', 'вводн', 'суб-обст', 'оп-аппоз', 'распред',
                 ...
                 'сочин', 'дат-субъект', 'присвяз', '2-компл', 'ROOT']